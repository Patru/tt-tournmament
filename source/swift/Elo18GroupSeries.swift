...
class Elo18GroupSeries: EloGroupSeries {
    ...
    class func series(for mother: EloSeries, index:Int, players: [SeriesPlayer], start time: String) -> Elo18GroupSeries {
   ...
   func secondStage(from first:Group, and second:Group) {
      ...
      // The creation of matches will add to list, so the overzealous warning is wrong ...
